...
namespace StudentAssignmentManager.Forms
{
    public partial class LoginForm : Form
    {
        ...
        {
            this.Text = "Student Assignment Manager - Login";
            ...
            StyleButton(btnLogin, "save");
            StyleButton(btnRegister, "cancel");
        }
        ...
        private void BtnLogin_Click(object sender, EventArgs e)
        {
            ...
            LoggedInStudent = _studentRepo.AuthenticateStudent(txtUsername.Text, txtPassword.Text);
