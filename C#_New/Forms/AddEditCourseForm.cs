    ...
    public partial class AddEditCourseForm : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            btnAddAssignment = new Button
            {
                ...
                Location = new Point(10, 390), // Add more space from the left
                Size = new Size(160, 35),    // Make button a bit smaller
            ...
            //StyleButton(btnAddAssignment, "add");
        ...
        {
            // Open AddEditAssignmentForm for this course
            var addAssignmentForm = new AddEditAssignmentForm(_editingCourse ?? new Course { StudentId = _currentStudent.StudentId });
        ...
        private void DeleteCourse()
        {
            ...
            {
                _courseRepo.Delete(_editingCourse.CourseId);
                _courseRepo.Save();
                this.DialogResult = DialogResult.OK;
                this.Close();
            }
        ...
        private void StyleButton(Button button, string type = "default")
        {
            ...
            switch (type)
            {
                ...
                case "cancel":
                    ...
                    //add : make it g
                case "add":
                    button.BackColor = Color.FromArgb(0, 200, 0);
                    button.ForeColor = Color.White;
                    button.FlatAppearance.BorderColor = Color.FromArgb(0, 102, 184);
                    button.MouseEnter += (s, e) => button.BackColor = Color.FromArgb(0,250,0);
                    button.MouseLeave += (s, e) => button.BackColor = Color.FromArgb(0, 255, 0);
                    break;
